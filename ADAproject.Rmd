...
survdiff(Surv(Survival.months,event.cat)~ insurance.cat, data = maindata.2)
```
#Interpretation
...
Based on log-rank test, there is significant difference between survivval curves/median survival of pancreatic cancer based on insurance status.[Chi-sq(2) = 464, p < 0.05)
